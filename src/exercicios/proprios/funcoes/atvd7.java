...
public class atvd7 {
    public static void main (String [] args){
        ...
        if (nota1 < 7 || nota2 < 7 || nota3 < 7){
            String pior = piorFilme(filme1, nota1, filme2, nota2, filme3, nota3);
            System.out.println("Pior filme: " + pior);
        }else {
            System.out.println("Todos os filmes foram bem avaliados!");
        }
    ...
    public static String piorFilme(String f1, double n1, String f2, double n2, String f3, double n3){
        String piorFilme = f1;
        double piornota = n1;
